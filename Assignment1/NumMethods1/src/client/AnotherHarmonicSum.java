...
public class AnotherHarmonicSum 
{
    ...
    private DefaultCategoryDataset createDataset(int N)
    {
    	...
    	for(int i = 1; i <= N; i++)
    	{
    		...
    		float hSingle = harmonicSumSingle(i);
    		double hDouble = harmonicSumDouble(i);
    ...
    private void createGraph(int N)
    {
    	...
    	JFreeChart lineGraph = ChartFactory.createLineChart("Harmonic Sum Comparison", "N values", "Sum", createDataset(N));
    	
    	// To make the dots (results of the Harmonic Sum function for N) appear by default in the graph
    ...
    public static void main(String[] args) 
    {
    	...
    	SwingUtilities.invokeLater(() -> {int N = 10; new AnotherHarmonicSum().createGraph(N);});
    }
